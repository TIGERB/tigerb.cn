...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220731175631.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220807232114.png" style="width:100%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220807234036.png" style="width:80%">
</p>

2. 栈内存释放逻辑：current + alloc

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220807234046.png" style="width:80%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220807235914.png" style="width:100%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220808002156.png" style="width:80%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20210129194928.png" style="width:80%">
</p>
...
<p align="center">
<img src="http://rmq67gta1.sabkt.gdipper.com/20220818132131.png
" style="width:70%">
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405133309.png" style="width:50%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220819133249.png" style="width:90%">
</p>

2. 如果`stackcache`内存不足，则从全局栈内存缓存池`stackpool`中分配：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234800.png" style="width:90%">
</p>

3. 如果`stackpool`内存不足，则从逻辑处理器结构`p`中的`p.pagecache`中分配：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220819133321.png" style="width:90%">
</p>

4. 如果`p.pagecache`内存不足，则从堆`mheap`中分配：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220819133338.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234822.png" style="width:90%">
</p>

2. 全局栈内存缓存池`stackLarge`不足，则从逻辑处理器结构`p`中的`p.pagecache`中分配，如果`p.pagecache`则去堆上`mheap`分配：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234828.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405235337.png" style="width:30%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405235126.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405235250.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234253.png" style="width:90%">
</p>

2. 线程缓存`mcache`的`tiny`内存不足，先去线程缓存`mcache`的`alloc`申请16B给`tiny`，再分配「微对象」所需内存，简易图示如下：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234330.png" style="width:90%">
</p>

申请16B详细过程图示如下：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234341.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220820172242.png" style="width:60%">
</p>

详细分配过程图示如下：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234425.png" style="width:90%">
</p>

2. 线程缓存`mcache`的`alloc`不足，则去中央缓存`mcentral`获取一个`mspan`，再分配「小对象」所需内存，图示如下：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234513.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234521.png" style="width:90%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234609.png" style="width:60%">
</p>

2. 逻辑处理器结构的`pagecache`不足，则直接去堆上`mheap`分配「大对象」所需内存，图示如下：

<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220405234616.png" style="width:60%">
</p>
...
<p align="center">
  <img src="http://rmq67gta1.sabkt.gdipper.com/20220503213918.png" style="width:80%">
</p>
